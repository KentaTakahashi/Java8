...
public class ExtendsClockUseLambda extends Frame implements Runnable {
    ...
    public ExtendsClockUseLambda(String str) {
    ...
    public static void main(String[] args) {
        ExtendsClockUseLambda clock  = new ExtendsClockUseLambda("ExtendsClock");
    ...
    private void setMyMenu() {
        ...
        menuProperty.addActionListener(e -> OpenMyDialog());
